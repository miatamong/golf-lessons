  ...
  en: {
    ...
    lessons: {
      ...
      pricing: {
        ...
        semiNote: 'adult · per person · 1 hour',
        twoPeople: '2 people',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'My child has never played - is that okay?', a: 'Absolutely. Willis has coached students of all ages, from preschoolers to adults, and every level, from first-timers to competitive players. Each lesson is tailored to the student, with a focus on solid fundamentals, confidence, and a genuine love for the game.' },
        ...
        { q: 'How do group lessons work?', a: 'At Westwood (Greentee), your child can join the GT4K Junior Program even without knowing the other students. If you already have friends or family you would like to learn with, you can book a semi-private lesson (2-3 people) as your own group. So you can join without knowing anyone, or bring your own small group - either works.', link: { url: 'https://greenteeacademy.com/junior/gt4k-program/', label: 'About the GT4K Junior Program' } },
        ...
        { q: 'What should I bring?', a: 'Bring your golf clubs and comfortable golf attire. No clubs yet? We can lend you a set.' },
      ],
    ...
    footer: {
      ...
      contact: 'Contact',
      role: 'CPGA Professional Golf Coach · Pitt Meadows & Coquitlam, BC',
  ...
  ko: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: '아이가 골프를 한 번도 안 해봤는데 괜찮을까요?', a: '물론입니다. 윌리스는 미취학 아동부터 성인까지, 초보부터 시합 준비 단계까지 모든 연령과 수준을 지도해 왔습니다. 각 레슨은 학생에게 맞춰 진행하며, 탄탄한 기본기와 자신감, 골프에 대한 진짜 흥미에 집중합니다.' },
        { q: '아이가 잘 늘고 있는지 어떻게 알 수 있나요?', a: '매 수업 후 명확한 피드백과 다음에 연습할 내용을 정리해 드립니다. 윌리스는 학부모님과 꾸준히 소통해서 아이의 성장 과정을 늘 알 수 있게 합니다.' },
        { q: '그룹 레슨은 어떻게 진행되나요?', a: 'Westwood(Greentee)에서는 GT4K 주니어 프로그램이 있어, 다른 학생을 몰라도 편하게 참여할 수 있습니다. 함께 배우고 싶은 친구나 가족이 있으면, 그 정해진 인원과 세미프라이빗(2~3인) 레슨으로 진행할 수 있습니다. 아는 사람이 없어도 되고, 있으면 같이 묶어서 배울 수도 있습니다.', link: { url: 'https://greenteeacademy.com/junior/gt4k-program/', label: 'GT4K 주니어 프로그램 자세히 보기' } },
        ...
        { q: '무엇을 준비해야 하나요?', a: '골프 클럽과 편한 골프 복장을 준비해 오세요. 클럽이 없으시면 대여해 드립니다.' },
      ],
    ...
    footer: {
      ...
      quickLinks: '바로가기',
      contact: '문의',
      role: 'CPGA 프로페셔널 골프 코치 · Pitt Meadows & Coquitlam, BC',
      rights: (year) => `© ${year} Willis Lee Golf. All rights reserved.`,
    },
