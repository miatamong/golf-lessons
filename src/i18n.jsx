  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'How do group lessons work?', a: 'At Westwood (Greentee), your child can join the GT4K Junior Program even without knowing the other students. At Swan-e-Set (and for semi-private lessons elsewhere), you bring the friends or family you would like to learn with.', link: { url: 'https://greenteeacademy.com/junior/gt4k-program/', label: 'About the GT4K Junior Program' } },
  ...
  ko: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: '그룹 레슨은 어떻게 진행되나요?', a: 'Westwood(Greentee)에서는 GT4K 주니어 프로그램이 있어 다른 학생을 몰라도 참여할 수 있습니다. Swan-e-Set 등 그 외 세미프라이빗 레슨은 함께 배울 친구나 가족을 직접 데려오시면 됩니다.', link: { url: 'https://greenteeacademy.com/junior/gt4k-program/', label: 'GT4K 주니어 프로그램 자세히 보기' } },
